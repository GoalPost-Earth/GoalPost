...
import { SpaceMembersSection, VisibilityChoice } from './space-sections'
...
export const SpaceDetailsBody: FC<{ spaceId: string; label?: string }> = ({
  ...
  // GOAL-295: nested fields also carry a direct Space edge; the drawer
  ...
  return (
    <div className="flex flex-col">
      ...
      {!isMe && <SpaceMembersSection members={members} />}

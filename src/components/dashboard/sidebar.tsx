    ...
    >
      ...
      <div className="px-4 pt-4 border-t border-glass-border mt-auto dark:border-white/10 shrink-0">
        <Link
          ...
          className="mb-3 flex items-center gap-3 rounded-lg border border-white/50 bg-white/70 px-3 py-2.5 text-sm font-medium text-slate-900 transition hover:bg-white dark:border-white/10 dark:bg-white/5 dark:text-white"
        >

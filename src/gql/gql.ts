...
const documents: Documents = {
  ...
  '\n  query getGraphPeople {\n    people {\n      id\n      name\n      email\n      ownsSpaces {\n        id\n        ... on MeSpace {\n          contexts {\n            id\n            pulses {\n              id\n            }\n          }\n        }\n        ... on WeSpace {\n          contexts {\n            id\n            pulses {\n              id\n            }\n          }\n        }\n      }\n    }\n  }\n':
    types.GetGraphPeopleDocument,
  '\n  query getGraphSpaces {\n    meSpaces {\n      id\n      name\n      visibility\n      createdAt\n      owner {\n        ... on Person {\n          id\n          name\n        }\n        ... on Community {\n          id\n          name\n        }\n      }\n      members {\n        ... on Person {\n          id\n          name\n        }\n        ... on Community {\n          id\n          name\n        }\n      }\n    }\n    weSpaces {\n      id\n      name\n      visibility\n      createdAt\n      owner {\n        ... on Person {\n          id\n          name\n        }\n        ... on Community {\n          id\n          name\n        }\n      }\n      members {\n        ... on Person {\n          id\n          name\n        }\n        ... on Community {\n          id\n          name\n        }\n      }\n    }\n  }\n':
    types.GetGraphSpacesDocument,
  '\n  query getGraphResonances {\n    fieldResonances {\n      id\n      label\n      description\n    }\n  }\n':
    types.GetGraphResonancesDocument,
  '\n  query getPersonDetails($email: String!) {\n    people(where: { email_EQ: $email }) {\n      id\n      name\n      email\n      ownsSpaces {\n        id\n        name\n        ... on MeSpace {\n          contexts {\n            id\n            title\n            pulses {\n              ... on GoalPulse {\n                id\n                content\n                createdAt\n                status\n                intensity\n              }\n              ... on ResourcePulse {\n                id\n                content\n                createdAt\n                resourceType\n                intensity\n              }\n              ... on StoryPulse {\n                id\n                content\n                createdAt\n                intensity\n              }\n            }\n          }\n        }\n        ... on WeSpace {\n          contexts {\n            id\n            title\n            pulses {\n              ... on GoalPulse {\n                id\n                content\n                createdAt\n                status\n                intensity\n              }\n              ... on ResourcePulse {\n                id\n                content\n                createdAt\n                resourceType\n                intensity\n              }\n              ... on StoryPulse {\n                id\n                content\n                createdAt\n                intensity\n              }\n            }\n          }\n        }\n      }\n    }\n  }\n':
    types.GetPersonDetailsDocument,
  '\n  query getSpaceDetails($spaceId: ID!) {\n    meSpaces(where: { id_EQ: $spaceId }) {\n      id\n      name\n      visibility\n      contexts {\n        id\n        title\n        emergentName\n        createdAt\n        pulses {\n          ... on GoalPulse {\n            id\n            content\n            createdAt\n            status\n            intensity\n          }\n          ... on ResourcePulse {\n            id\n            content\n            createdAt\n            resourceType\n            intensity\n          }\n          ... on StoryPulse {\n            id\n            content\n            createdAt\n            intensity\n          }\n        }\n      }\n    }\n    weSpaces(where: { id_EQ: $spaceId }) {\n      id\n      name\n      visibility\n      contexts {\n        id\n        title\n        emergentName\n        createdAt\n        pulses {\n          ... on GoalPulse {\n            id\n            content\n            createdAt\n            status\n            intensity\n          }\n          ... on ResourcePulse {\n            id\n            content\n            createdAt\n            resourceType\n            intensity\n          }\n          ... on StoryPulse {\n            id\n            content\n            createdAt\n            intensity\n          }\n        }\n      }\n    }\n  }\n':
    types.GetSpaceDetailsDocument,
  '\n  query getResonanceDetails($resonanceId: ID!) {\n    fieldResonances(where: { id_EQ: $resonanceId }) {\n      id\n      label\n      description\n    }\n  }\n':
    types.GetResonanceDetailsDocument,
  '\n  query getPerson($id: ID!) {\n    people(where: { id_EQ: $id }) {\n      id\n      name\n      email\n      ownsSpaces {\n        id\n        name\n        visibility\n        createdAt\n      }\n    }\n  }\n':
